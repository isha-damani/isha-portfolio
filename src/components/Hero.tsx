  ...
  return (
    <section className="min-h-[85vh] flex items-center justify-center px-6">
      <div className="container max-w-4xl text-center">
        <p className="text-muted-foreground font-sans text-sm tracking-wide uppercase mb-4">
          Welcome to my portfolio
        </p>

        <h1 className="font-serif text-5xl md:text-7xl font-medium text-foreground mb-6">
          Isha Damani
        </h1>

        <p className="font-sans text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
          Student exploring data science, analysis, and applied programming
        </p>
